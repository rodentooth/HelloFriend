    ...
    public class AsyncTask_hotPeople extends android.os.AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (type.equals("get_users")) {
                try {
                    String URL = "http://snapchat.frozensparks.com/get_likers.php";


                    SharedPreferences filter2 = context.getSharedPreferences("user", MODE_PRIVATE);
                    int id = filter2.getInt("userid", 0);
            ...
            if (type.equals("unlock_liker")) {
                try {
                    sc_username = params[2];

                    String URL = "http://snapchat.frozensparks.com/unlock_liker.php";
                    ...
                    String post_data = URLEncoder.encode("id", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(id), "UTF-8") + "&" +
                            URLEncoder.encode("id_to_buy", "UTF-8") + "=" + URLEncoder.encode(params[1], "UTF-8") + "&" +
                            URLEncoder.encode("price", "UTF-8") + "=" + URLEncoder.encode(String.valueOf(unlock_liker_price), "UTF-8");
                    bufferedWriter.write(post_data);
                    bufferedWriter.flush();
                    bufferedWriter.close();
                    outputStream.close();
            ...
            if (result != null) {
                ...
                if (type.equals("unlock_liker")) {
                    if (result.equals("OK")) {
                        ...
                        SharedPreferences prefs3 = context.getSharedPreferences(
                                "user", Context.MODE_PRIVATE);
                        final int credits = prefs3.getInt("credits", 0);

                        SharedPreferences.Editor editor1 = getActivity().getSharedPreferences("user", MODE_PRIVATE).edit();
                        editor1.putInt("credits", credits-unlock_liker_price);
                        editor1.apply();


                        SharedPreferences prefs2 = context.getSharedPreferences(
                                "user_storage", Context.MODE_PRIVATE);
                        final String blockstring = prefs2.getString("unlocked_likers", "0");

                        SharedPreferences.Editor editor = context.getSharedPreferences("user_storage", MODE_PRIVATE).edit();
                        editor.putString("unlocked_likers", blockstring + "," + sc_username);
                        editor.apply();

                        Snackbar snack = Snackbar.make(view, R.string.unlockedperson, Snackbar.LENGTH_LONG);
                        View view2 = snack.getView();
                        TextView tv = view2.findViewById(android.support.design.R.id.snackbar_text);
                        tv.setTextColor(Color.WHITE);
                        snack.show();

                        likes_fragment nextFrag= new likes_fragment();
                        getActivity().getSupportFragmentManager().beginTransaction()
                                .replace(R.id.content_main, nextFrag,"likes_fragment")
                                .addToBackStack(null)
                                .commit();
                    }
                    else {
...
//                    params2.setMargins(5,0,5,5);
                        ...
                        final String blockstring2 = prefs2.getString("unlocked_likers", "");
                        ...
                        image.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if(!finalUnlocked) {
                                    ...
                                    // set title
                                    alertDialogBuilder.setTitle(R.string.unlockthisperson);

                                    // set dialog message
                                    alertDialogBuilder.setMessage(R.string.itcosts20diamonds);
                                    alertDialogBuilder
                                            .setCancelable(false)
                                            .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int i) {
                                                    ...
                                                    int credits = (prefs.getInt("credits", 0));
                                                        ...
                                                        final AsyncTask_hotPeople get_user = new AsyncTask_hotPeople(getContext());
                                                        get_user.execute("unlock_liker", String.valueOf(id), String.valueOf(id));




                                                        //dialog want to unlock:
                                                }
                                            })
                                            .setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
